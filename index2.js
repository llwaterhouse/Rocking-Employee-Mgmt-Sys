const { prompt } = require("inquirer"); // if we don't deconstruct, we can use inquirer.prompt
const logo = require("asciiart-logo");
// const db = require("./db"); // implies "./db/index.js"
...
async function loadMainPrompts() {
  console.log ("in load Main prompts");
  const { choice } = await prompt([ // the data is in "choice"  otherwise use answer.choice
    {
      type: "list",
      name: "choice",
...
async function viewEmployees() {
  ...
  // loadMainPrompts(); // asks user for their next choice
}
